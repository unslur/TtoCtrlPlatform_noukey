...
public:
	...
	static BOOL NormalPrint2(const char *code2d,int index,bool firstFlag,int& retFlag);
	static BOOL NormalPrint3(const char *code2d,int index,bool firstFlag,int& retFlag);
	static BOOL NormalPrint3_test(const char *code2d,int index,bool firstFlag,int& retFlag);
